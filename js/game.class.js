class GameClass {
  ...
  start() {
    const gameCircle = this.createCircle(this.circleSize, 0x00000, 0xffffff);
    this.createArc();
    ...
    this.app.ticker.add(() => {
      if (rhythmWrapper.style.transform) {
        ...
        gameCircle.child.drawEllipse(this.widthCenter, this.heightCenter, this.circleSize, this.circleSize);
